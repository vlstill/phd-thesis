...
Finally, it remains to be seen if the program transformation used in our \xtso support can be efficiently combined with the program transformation that introduces symbolic and abstract data as presented in \mcite{LRB2018}, without the need to tightly integrate the two transformations.
