...
support for C++. LLBMC~\mcite{sinz12:llbmc} and
NBIS~\mcite{gunther14:increm.bounded} are \llvm{}-based bounded model
checkers which target mainly C and have no support for exceptions or the
C++ standard library. VVT~\mcite{gunther16:vienna.verific.tool} is a
...
Furthermore, KLEE~\mcite{cadar08:klee} and KLOVER~\mcite{li11:klover}
are \llvm{}-based tools for test generation and symbolic execution. KLOVER
targets C++ and according to~\mcite{li11:klover} has exception support,
...
Both CBMC~\mcite{clarke04:tool.checkin, kroening14:cbmc} and
ESBMC~\mcite{ramalho13:smt.based} bounded model checkers support C++
...
constructs. This approach was taken in~\mcite{prabhu11:interp.except},
