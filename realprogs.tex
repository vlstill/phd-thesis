...
numberic manipulation of pointer values.} and function pointers.
...
\autoref{sec:lang:except} then takes more detailed look at the particular case of excetion support in DIVINE 4; this part was originally published in \mcite{SRB2017}.
...
Reuse of execution-oriented componenents (such as compilers and libraries) for
...
library.\mnote{An example is a data race in an initialization of C++ threads in
\texttt{libc++} discovered by DIVINE.
This bug was later fixed by the \texttt{libc++} developers.}
...
In order to provide support for most of C and C++, DIVINE has to provide standard libraries for these languages.
...
All source code related to this work, along with supplementary material, are available online under a permissive open-source licence.\mnote{\url{https://divine.fi.muni.cz/2017/exceptions}}
...
of the \cpp{try-catch} syntax, and throwing an exception triggers an error.\mnote{A
...
reference (which is the recommended practice in C++) results in spurious syntax error during program parsing.}
