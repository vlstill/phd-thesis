...
\texttt{landingpad} that is about to be executed.\mnote{LLVM registers are function-local values that cannot be used to pass information between functions in pure LLVM.
