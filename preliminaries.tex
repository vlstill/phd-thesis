...
platform-specific layout of the stack will be reported as buggy (the stack
layout is not guaranteed by the C/C++ standards and therefore such programs are
not well-defined).
...
DIVINE uses program instrumentation to facilitate program analysis.
