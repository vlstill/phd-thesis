...
described by the processor vendor~\mcite{x86tso}.
...
variants of POWER~\mcite{Sarkar2011},\mcite{MadorHaim2012} and
ARM~\mcite{Alglave2014}, \mcite{Flur2016}, \mcite{Pulte2017} memory models.
...
\cpp{atomic} template class for atomic variable, but C relies on the
...
formalize it was given in \mcite{cppmemmod}, formalizing the N3092 draft of the
standard \cite{N3092}.
...
but makes results of data races defined \mucite{llvm:langref}.
...
\section{Hardware-Related Considerations ??}
...
It is built on an explicit-state core called \divm which interprets LLVM
