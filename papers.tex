...
The paper contains an evaluation and is accompanied by a publicly available implementation.
...
We show that with a careful design we can successfully reuse exception handling code from the standard C++ library.
...
In this tool paper we describe overall architecture of DIVINE 4 and changes in the tool compared to DIVINE 3.
...
This paper introduces the concept of virtual machine with graph memory as a core component for explicit-state and abstraction-based verification of software.
