...
$k$-induction~\cite{Donaldson2011}, \cite{Gadelha2017} is an extension of
...
\TODO{\textsc{Dartagnan}~\cite{PonceDeLeon2020}, \cite{Gavrilenko2019}}
...
- CTIGAR = SMT-based IC3 with CEGAR (Counterexample-Guided Abstraction Refinement \TODO{\cite{Birgmeier2014}, \cite{Bradley2011}}
- parallel C programs
...
\textsc{Ultimate Taipan}~\cite{Dietsch2020}, \cite{Greitschus2017}
...
SMACK~\cite{Rakamaric2014}, \cite{Carter2016}, \cite{Garzella2020}
...
\textsc{PeSCo}~\cite{Richter2019}, \cite{Czech2017}
...
\textsc{JDart}~\cite{Mues2020}, \cite{Luckow2016}
...
- uses compositional proof rules for concurrent programs~\cite{Jones1983}, \cite{Owicki1976}
...
2LS~\cite{Malik2020}, \cite{Malik2018}, \cite{Chen2017}
