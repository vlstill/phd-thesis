...
BMC~\cite{Biere1999} (Symbolic MC without BDDs)
- the introductory paper, starting from symbolic model checking
- SAT based
- BMC for LTL (to detect loops checks that the last state of the bounded run is equal to some of the previous states)
- used a modelling language
