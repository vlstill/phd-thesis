Historically, automatic analysis techniques for parallel programs focused on analysis of models of systems.
...
An early example of this idea was introduced by Lipton in \mcite{Lipton1975}.
...
A dead-variable elimination \mcite{Yorav2004} can be also seen as an instance
...
language which is executed by JVM.} languages (e.g., Scala, Kotlin).
...
Currently, it supports symbolic bitvector manipulations for both integeral and floating-point data types and symbolic string representation \mcite{CLOR2019}.
...
RCMC \mcite{Kokologiannakis2017} is a stateless model checker for C and C++ programs running under the RC11 memory model \mcite{Lahav2017} (which is an attempt to formalize and fix the C11 memory model).
