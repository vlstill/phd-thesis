...
Corral \mcite{Lal2012}
- runs the Boogie modelling language + language front-ends for C and .NET bytecode
- parallel programs handled using sequentialization
- bounded, uses abstraction and refinement (abtract program tracks values of only a selected set of variables, over-approximations of function effects refined with inlining the actual function)
