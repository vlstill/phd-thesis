...
\ifcsname mcite: \thepage : \ci\endcsname \else\expandafter\def\csname mcite: \thepage : \ci\endcsname{}\marginpar{\footnotesize\cite{\ci} \citeauthor*{\ci}, \citetitle{\ci}.#3}\fi%
}}
