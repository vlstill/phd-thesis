...
\newcommand{\mcite}[2][]{\cite[#1]{#2}\ifcsname mcite: \thepage : #2\endcsname \else\expandafter\def\csname mcite: \thepage : #2\endcsname{}\marginpar{\footnotesize\cite{#2}: \citeauthor{#2}, \citetitle{#2}.}\fi}
