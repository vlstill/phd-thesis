...
\newcommand{\raggedoutunchecked}{\ifoddpage\RaggedRight\else\RaggedLeft\fi}
\newcommand{\raggedout}{\checkoddpage\raggedoutunchecked}
...
\ifcsname mcite: \oddpage@page : \ci\endcsname \else%
\expandafter\def\csname mcite: \oddpage@page : \ci\endcsname{}%
\marginpar{%
  \raggedoutunchecked\footnotesize\cite{\ci} \citeauthor*{\ci}, \citefield{\ci}[titlelink]{title}.#3%
}\fi%
}%
\cite[#1]{#2}%
}
