...
\ifcsname mcite: \oddpage@page : \ci\endcsname \else\expandafter\def\csname mcite: \oddpage@page : \ci\endcsname{}\marginpar{\raggedout\footnotesize\cite{\ci} \citeauthor*{\ci}, \citetitle{\ci}.#3}\fi%
}%
\cite[#1]{#2}%
}
\makeatother
