...
\usepackage{pgf}
\usepackage{tikz}
\usetikzlibrary{arrows,positioning,shapes,snakes,automata,backgrounds,petri,fit}
\usepackage{pdfpages}
...
\newcommand{\mnotemark}{\stepcounter{mnote}\hyperlink{mnote:\themnote}{${}^\arabic{mnote}$}\xspace}
\newcommand{\mnotetext}[1]{\marginnote{\hypertarget{mnote:\themnote}{${}^\arabic{mnote}\,$}\footnotesize{}#1}}
\newcommand{\mnote}[1]{\mnotemark\mnotetext{#1}\xspace}
