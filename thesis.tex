...
\newenvironment{marginnote}{%
        \mnotemark%
        \raggedout% make sure the contents is or the right side of the box so it is not outside the page
        \expandafter\newbox\csname marginnotebox:\thechapter:\themnote\endcsname%
        \expandafter\setbox\csname marginnotebox:\thechapter:\themnote\endcsname=\vbox\bgroup%
            \noindent%
            \begin{minipage}{\marginparwidth}%
            \hypertarget{mnote:\thechapter:\themnote}{${}^{\arabic{mnote}}\,$}%
            \raggedoutunsafe\footnotesize\noindent%
    }{%
            \end{minipage}%
        \egroup%
        \marginpar{\expandafter\unvbox\csname marginnotebox:\thechapter:\themnote\endcsname}
    }
