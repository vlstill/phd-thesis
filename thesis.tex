...
\usepackage{pgf}
\usepackage{tikz}
\usetikzlibrary{arrows,positioning,shapes,snakes,automata,backgrounds,petri,fit,decorations.pathreplacing}
\tikzset{
    *|/.style={
        to path={
...
\newcommand{\mnotetext}[1]{\marginnote{\hypertarget{mnote:\thechapter:\themnote}{${}^\arabic{mnote}\,$}\footnotesize{}#1}}
